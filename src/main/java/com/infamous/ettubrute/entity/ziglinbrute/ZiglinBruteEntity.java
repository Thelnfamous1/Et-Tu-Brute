...
public class ZiglinBruteEntity extends ZombifiedPiglinEntity {
    ...
    public static boolean canZiglinBruteSpawn(EntityType<ZiglinBruteEntity> entityType, IWorld world, SpawnReason spawnReason, BlockPos blockPos, Random rand) {
    ...
    public void func_230258_H__() {
        this.func_230260_a__(field_234346_bv_.getRandomWithinRange(this.rand));
    }
